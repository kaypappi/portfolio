<template>
    <div
        ...
        <div
            class=" mt-6 md:mt-0 col-span-12 md:col-span-7 md:border-l  text-lg border-l-grey-700 flex gap-10 items-center justify-center md:justify-start md:pl-10">
            <NuxtLink v-for="item in footer" :to="item.link" target="_blank">
