<template>
    <div class=" w-full grid grid-cols-1 md:grid-cols-2 text-black ">
...
const query = groq`*[_type == "philosophy"][0]`
const { data, refresh } = await useAsyncData('philosophy', () => sanity.fetch(query))
</script>