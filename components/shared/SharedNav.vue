<template>
    <nav ref="mainNav"
        :class="['sticky top-0 py-0  sticky-nav !leading-tight transition-colors flex text-white duration-500 text-sm px-4 md:px-16 xl:px-40', { '  border-t border-b border-grey-700': opacity > 0 }, { ' backdrop-blur-md border-0  shadow-xs shadow-white ': opacity <= 0 },{'bg-white/10':opacity<=0 && dark},{'bg-black/40':!dark}]">
