<template>
    <div class="">
        ...
        <div
            class="flex mt-2 bg-white  max-w-sm  items-center p-4 rounded-md shadow-[0px_4px_10px_rgba(0,0,0,0.08)] text-opacity-50 text-black">
            <textarea required :name="name" :style="{ 'outline': 'none' }" :value="modelValue"
